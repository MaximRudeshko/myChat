...
function App() {
  ...
  const dialogsData = [
    ...
    {
        id: '7a80be16fb3c914df119cd0e60ba18ba',
        userName: 'NoName',
        messageText: 'I love u, motherfucker',
    ...
    {
        id: 'd6538a6c175105eda2482b28ea7df021',
        userName: 'Alesya Dakhno',
        // avatar: 'https://sun9-43.userapi.com/c851028/v851028358/190260/QVMurYscTvo.jpg',
        messageText: 'I love u, motherfucker',
        date: new Date(2020, 9, 27, 12,5 ),
    ...
    {
        id: '786ba114be6cd1e859024fbd370d1de3',
  ...
  return (
    <div className="App">
        ...
        <Route exact path="/home" render={() => <Home items = {dialogsData}/>} />
    </div>
  );
}
